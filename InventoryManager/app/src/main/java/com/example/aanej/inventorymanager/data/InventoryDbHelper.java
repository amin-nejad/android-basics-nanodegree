package com.example.aanej.inventorymanager.data;
...
import com.example.aanej.inventorymanager.R;
...
public class InventoryDbHelper extends SQLiteOpenHelper {
    ...
    public InventoryDbHelper(Context context) {
        ...
        currency = context.getResources().getString(R.string.currency_denomination);
    }
    ...
    public void insertItem(StockItem item) {
        ...
        String item_price = currency + item.getPrice();

        values.put(StockContract.StockEntry.COLUMN_NAME, item.getProductName());
        values.put(StockContract.StockEntry.COLUMN_PRICE, item_price);
