    ...
    private static List<Book> extractFeatureFromJson(String BookJSON) {
        ...
        try {
            ...
            for (int i = 0; i < BookArray.length(); i++) {
                ...
                String fullDate = properties.getString("publishedDate");
                String yearString = getYear(fullDate);
                int year = Integer.valueOf(yearString);
                String pagesString = properties.getString("pageCount");
                ...
                Book Book = new Book(year, title, author, pages,language,url);
